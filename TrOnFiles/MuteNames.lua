...
if DevRio:get(TrOn.."Rio:Lock:MuteNames"..msg.chat_id_) then
if Manager(msg) then
...
DevRio:sadd(TrOn.."Rio:Mute:Names"..msg.chat_id_, MuteName)
end
...
if not Manager(msg) and DevRio:get(TrOn.."Rio:Lock:MuteNames"..msg.chat_id_) then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
if result.id_ then 
TrOnName = ((result.first_name_ or "") .. (result.last_name_ or ""))
if TrOnName then 
TrOnNames = DevRio:smembers(TrOn.."Rio:Mute:Names"..msg.chat_id_) or ""
if TrOnNames and TrOnNames[1] then 
for i=1,#TrOnNames do 
if TrOnName:match("(.*)("..TrOnNames[i]..")(.*)") then 
...
DevRio:set(TrOn.."Rio:Lock:MuteNames"..msg.chat_id_,true)
end
...
DevRio:del(TrOn.."Rio:Lock:MuteNames"..msg.chat_id_)
end
end
end
